    ...
    function () {
        requirejs(
            ...
            function ($) {
                ...
                $('#form_addSocial').bootstrapValidator({
                    feedbackIcons: {
                        valid: 'fa fa-check',
                        invalid: 'fa fa-close',
                ...
                // 异步提交表单
                $('#btn_submitAddSocial').bind('click',function (){
                    var bootstrapValidator = $('#form_addSocial').data('bootstrapValidator'); // 获取表单对象
                    ...
                    if (bootstrapValidator.isValid()) // 全部验证通过，才能提交表单
                    {
                        var options = {
                            ...
                            url: '/student/addSocial',
                            dataType: 'json',
                            resetForm: true  // 成功提交后，重置所有的表单元素的值
                        };
                        $('#form_addSocial').ajaxSubmit(options); // 异步提交
                    }
                });
