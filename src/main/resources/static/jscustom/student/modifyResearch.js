    ...
    function () {
        requirejs(
            ...
            function ($) {
                ...
                $('#form_modifyResearch').bootstrapValidator({
                    feedbackIcons: {
                        valid: 'fa fa-check',
                        invalid: 'fa fa-close',
                ...
                // 异步提交表单
                $('#btn_submitModifyResearch').bind('click',function (){
                    var bootstrapValidator = $('#form_modifyResearch').data('bootstrapValidator'); // 获取表单对象
                    ...
                    if (bootstrapValidator.isValid()) // 全部验证通过，才能提交表单
                    {
                        var options = {
                            ...
                            url: '/student/modifyResearch',
                            dataType: 'json',
                            resetForm: true  // 成功提交后，重置所有的表单元素的值
                        };
                        $('#form_modifyResearch').ajaxSubmit(options); // 异步提交
                    }
                });
